...
const [isLoading , setIsLaoding] = useState(false)
  ...
  return (
    <div className="relative  flex  flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
              <Link class="relative mx-3 mt-3 flex overflow-hidden rounded-xl" to={'/ProductDetails/'+product._id}>
                <img class="object-contain w-full" src={product.imageCover} alt={product.title} />
              ...
              <div className="mt-4 px-5 pb-5  grow flex flex-col justify-between">
                ...
                <Button isLoading ={isLoading } onPress={() => addProductToCart(product._id,setIsLaoding)} className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
